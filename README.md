### [threenow](https://github.com/warren-bank/crx-threenow/tree/webmonkey-userscript/es5)

[Userscript](https://github.com/warren-bank/crx-threenow/raw/webmonkey-userscript/es5/webmonkey-userscript/threenow.user.js) to run in:
...
Its purpose is to:
* redirect embedded videos from [threenow.co.nz](https://www.threenow.co.nz/) to an external player

#### Notes:

* the data API endoint to obtain the URL for video streams can only be accessed from within New Zealand
  - a VPN is required from elsewhere to query the data API endoint
  - login is _not_ required
* the URL for video streams can only be accessed from within New Zealand
